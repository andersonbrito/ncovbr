...
Repository containing scripts to perform near-real time tracking of SARS-CoV-2 using genomic data.
...
|        new_genomes.fasta¹       | Newly sequenced genomes, with headers formatted as ">Genome-XXX", available in a custom, optional fasta file |
| metadata_nextstrain.tsv² | File 'metadata.tsv' available from GISAID |
|    sequencing_metadata.xlsx³    |                     Metadata spreadsheet downloaded from an internal Google Sheet                    |
...
* [Anderson Brito](https://andersonbrito.github.io/)
